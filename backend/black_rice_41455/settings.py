"""
Django settings for black_rice_41455 project.
...
ROOT_URLCONF = 'black_rice_41455.urls'
...
WSGI_APPLICATION = 'black_rice_41455.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_rice_41455 API",
    "DESCRIPTION": "API documentation for black_rice_41455 App",
    "VERSION": "v1",
}
